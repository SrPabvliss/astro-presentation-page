        ...
        <div className="container mx-auto px-4 flex flex-wrap gap-5 justify-center items-center mt-8">
          {project.links?.demo && (
            <motion.a
              ...
              className="px-8 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 shadow-md text-white font-semibold text-lg transition-all duration-200"
              tabIndex={0}
            >
              View Live Demo
            </motion.a>
